...
namespace Ultima5Redux.References.PlayerCharacters.Inventory
{
    public class ArmourReference : CombatItemReference
    {
        ...
        public enum SpecificAmulet
        {
            AmuletOfTurning = 0x247,
            SpikedCollar = 0x248,
            Ankh = 0x249
        }
        ...
        public enum SpecificRing
        {
            RingInvisibility = 0x244,
            RingProtection = 0x245,
            RingRegeneration = 0x246
        }
