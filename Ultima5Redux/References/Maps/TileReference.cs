...
namespace Ultima5Redux.References.Maps
{
    ...
    public class TileReference
    {
        ...
        public enum SpriteIndex
        {
            ...
            Fighter_KeyIndex = 328, Bard_KeyIndex = 324, BardPlaying_KeyIndex = 348, TownsPerson_KeyIndex = 336,
            Ray_KeyIndex = 400, Fireplace = 188, 
            ...
            ItemMoney = 258, Beggar_KeyIndex = 365
        }
