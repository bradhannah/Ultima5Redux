...
{
    public class CombatMapLegacy : Map
    {
        ...
        private readonly SingleCombatMapReference _mapRef;
        ...
        // These are the legacy structures read in from the file. They will need to be abstracted into usable data.
