...
namespace U5ConversationSimulator
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            world.State.TheVirtualMap.LoadSmallMap(world.SmallMapRef.GetSingleMapByLocation(SmallMapReferences.SingleMapReference.Location.Jhelom, 0), world.State.CharacterRecords, false);
